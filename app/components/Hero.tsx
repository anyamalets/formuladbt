    ...
    <section className="relative bg-[var(--color-bg)]">
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 py-24 md:py-32 lg:py-40">
        ...
        <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4">
          <Link
            href={HERO.cta.href}
            className="inline-flex items-center justify-center px-8 py-4 rounded-lg bg-[var(--color-primary)] text-white text-[16px] font-medium hover:bg-[var(--color-primary-dark)] transition-colors min-h-12"
          >
            {HERO.cta.label}
          </Link>
          <Link
            href={HERO.ctaSecondary.href}
            className="inline-flex items-center justify-center px-8 py-4 rounded-lg border-1.5 border-[var(--color-primary)] text-[var(--color-primary)] text-[16px] font-medium hover:bg-[var(--color-bg-deep)] transition-colors min-h-12"
